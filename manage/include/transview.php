                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="invoice-title">
                      ...
                      <div class="invoice-number">Order #<?php echo $trans_ref ?></div>
                    </div>
                    <hr>
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover table-md">
                        ...
                        <tr>
                          ...
                          <td><?php echo $product_details['prod_name'] ?></td>
                          <td><?php echo $product_details['prod_price'] ?></td>
                    ...
                    <div class="row mt-4">
                      ...
                      <div class="col-lg-4 text-right">
                        ...
                        <div class="invoice-detail-item">
                          <div class="invoice-detail-name">Total Amount Paid</div>
