            ...
            <div class="blog single mt-n17">
              <div class="card shadow-lg">
                    ...
                    <div class="col-xl-10 mx-auto">
                         <h2 class="fs-15 text-uppercase text-primary mb-3"> Download Publications</h2>
                    </div>
                            <!-- /.row -->
                                ...
                                <div class="col-md-10 col-lg-10">
                                    <div class="card-body p-5 d-flex flex-row" class="col-md-10 col-lg-10">
                                        ...
                                        <div>
                                            ...
                                            <span class="badge bg-pale-blue text-blue rounded py-1 mb-2"><h6 class="mb-0 text-body"><?php echo  $view['author']." (".$view['pub_year'].")"?></h6></span>
                                            <h6 class="mb-0 text-body"><?php echo  $view['pub_name']?></h6>
                                            
                                            <a href="<?php echo  $view['pub_file']?>" class="btn btn-expand btn-primary rounded-pill">
